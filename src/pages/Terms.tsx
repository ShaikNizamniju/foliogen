    ...
    return (
        <div className="min-h-screen bg-background text-foreground">
            ...
            <main className="container mx-auto px-4 py-16 max-w-3xl">
                <h1 className="text-4xl font-bold text-foreground mb-8">Professional Identity Verification (Terms)</h1>
                ...
                <div className="max-w-none">
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-semibold text-foreground mb-4">1. Identity Verification Standards</h2>
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-semibold text-foreground mb-4">2. AI-Narrative Responsibility</h2>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-semibold text-foreground mb-4">3. Professional Ethics & Use</h2>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-semibold text-foreground mb-4">4. Paid Services & Brand Autonomy</h2>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-semibold text-foreground mb-4">5. Termination Clause</h2>
                        <p className="text-muted-foreground leading-relaxed">
